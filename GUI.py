...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fmax_label = QtWidgets.QLabel(self.uper_widget)
        self.fmax_label.setObjectName("fmax_label")
        self.horizontalLayout.addWidget(self.fmax_label)
        ...
        self.sec_graph_title_label.setAlignment(QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.phase_shift_label.sizePolicy().hasHeightForWidth())
        ...
        self.list_of_sinusoidals = QtWidgets.QListWidget(self.Composer)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Signal Illustrator"))
        self.Reconstruct_botton.setText(_translate("MainWindow", "Reconstruct"))
        self.main_graph_title_label.setText(_translate("MainWindow", "main graph"))
        self.slider_value_label.setText(_translate("MainWindow", "0"))
        self.fmax_label.setText(_translate("MainWindow", "fmax = 0"))
        self.sec_graph_title_label.setText(_translate("MainWindow", "Reconstructed graph"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.Sampling), _translate("MainWindow", "Sampling"))
        self.current_wave_title_label.setText(_translate("MainWindow", "current wave"))
        ...
        self.final_graph_title_label.setText(_translate("MainWindow", "final output"))
        self.list_view_title_label.setText(_translate("MainWindow", "list of sinusoidals"))
        self.move_botton.setText(_translate("MainWindow", "MOVE"))
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.Composer), _translate("MainWindow", "Composer"))
